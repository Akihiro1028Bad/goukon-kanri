...
#### 確認環境
- **デバイス**: iPhone SE (375px), iPhone 12 (390px), iPad (768px), Desktop (1280px)
- **ブラウザ**: Safari (iOS), Chrome (Android/Desktop)
...
19. 実機（iPhone/Android）での動作確認
20. Chrome DevToolsでの各ブレークポイント確認
21. PR作成・レビュー依頼
